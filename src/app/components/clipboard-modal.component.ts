...
import { RemoteDesktopService } from '@raytecvision/ngx-remote-desktop';
...
@Component({
  ...
  template: `
    ...
    <div class="modal-body">
      <p>
        Text copied/cut within the remote desktop will appear here. Sending the
        text below will affect the remote desktop clipboard.
      </p>
